    ...
    <div class="col-6">
        <div class="card card-info h-100">
            ...
            <div class="card-body">
                ...
                <f:display bean="person" property="hasPrimaryAttentionFile" label="Tiene expediente en atención primaria" wrapper="display/inline" />
                <f:display bean="person" property="hasOtherResourcesCase" label="Tiene intervención con otros recursos" wrapper="display/inline" />
                <f:display bean="person" property="otherResourcesCase" label="Otros recursos" wrapper="display/inline" />
                <f:display bean="person" property="hasEtmfCase" label="Tiene en ETMF" wrapper="display/inline" />
                <f:display bean="person" property="caiCase" label="Expendiente en CAI" wrapper="display/inline" />
                <f:display bean="person" property="hasCafCase" label="Tiene caso en CAF" wrapper="display/inline" />
            </div>
        </div>
    </div>
  </div>
